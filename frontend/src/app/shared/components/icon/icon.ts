...
export class Icon {
  ...
  get svg(): SafeHtml {
    const raw = `<svg xmlns="http://www.w3.org/2000/svg" w-full h-full fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="${this.strokeWidth}">${ICONS[this.name] ?? ''}</svg>`;
